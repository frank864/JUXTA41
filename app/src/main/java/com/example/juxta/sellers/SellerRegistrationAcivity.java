...
public class SellerRegistrationAcivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_registration_acivity);
        ...
        sellerLoginBegin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(SellerRegistrationAcivity.this, SellerLoginActivity.class);
                    ...
                    if (task.isSuccessful()){
                        ...
                        rootRef.child("Sellers").child("sid").updateChildren(sellerMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                Toast.makeText(SellerRegistrationAcivity.this, "You are registered successfully", Toast.LENGTH_SHORT).show();

                                Intent intent= new Intent(SellerRegistrationAcivity.this, SellerHomeActivity.class);
